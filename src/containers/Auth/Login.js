                            ...
                            <div className='login-password'>
                                ...
                                <div className='login-showpass' onClick={this.handleShowPassword}>
                                    {!this.state.isShowPassword &&
                                        <i tabindex="0" role="button" aria-label="accessibilityLabels_login_modal_eyeClosedIcon" aria-pressed="false" class="tiktok-tnebwf-IPasswordIcon etcs7ny3">
                                    ...
                                    {this.state.isShowPassword &&
                                        <i tabindex="0" role="button" aria-label="accessibilityLabels_login_modal_eyeOpenIcon" aria-pressed="true" class="tiktok-tnebwf-IPasswordIcon etcs7ny3">
